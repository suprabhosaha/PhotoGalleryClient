...
export const pinDetailQuery = (pinId) => {
  const query = `*[_type == "gallery" && _id == '${pinId}']{
    image{
      asset->{
        url
      }
...
export const pinDetailMorePinQuery = (pin) => {
  const query = `*[_type == "gallery" && category == '${pin.category}' && _id != '${pin._id}' ]{
    image{
      asset->{
        url
      }
...
export const feedQuery = `*[_type == 'gallery'] | order(_createdAt desc) {
    image {
        asset -> {
            url
        }
