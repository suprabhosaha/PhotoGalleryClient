                ...
                <div className="w-full p-5 flex-1 xl:min-w-620">
                    ...
                    <div className="flex flex-wrap mt-6 gap-3">
                        <Link
                            ...
                            className="flex gap-2 my-auto items-center bg-white rounded-lg">
                        ...
                        <button
                            type="button"
                            className="bg-red-500 text-white rounded-full px-6 py-2 my-2 font-semibold text-base outline-none hover:bg-red-600"
                            onClick={addComment}
                        >
