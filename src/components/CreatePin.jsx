          ...
          <div className=" flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                ...
                <button
                  type="button"
                  className="absolute bottom-0 right-0 p-3 rounded-full bg-red-500 hover:bg-red-400 text-xl cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out"
